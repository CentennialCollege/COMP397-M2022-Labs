...
public class TileGenerator : MonoBehaviour
{
    ...
    private void Generate()
    {
        ...
        {
            // spawn a Robot
            randomObject = Instantiate(robotPrefab, spawnPoint.position + new Vector3(0.0f, 0.3f, 0.0f),
                Quaternion.identity);
        ...
        {
            // spawn a coin
            randomObject = Instantiate(coinPrefab, spawnPoint.position + new Vector3(0.0f, 1.5f, 0.0f),
                Quaternion.identity);
